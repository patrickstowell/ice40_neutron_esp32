...
namespace NEUTRON {
  ...
  void ConfigureFPGA(){
    ...
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x0E, CONFIG::NEUTRON_I2C_BYTE0E);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x0F, CONFIG::NEUTRON_I2C_BYTE0F);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x10, CONFIG::NEUTRON_I2C_BYTE10);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x11, CONFIG::NEUTRON_I2C_BYTE11);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x12, CONFIG::NEUTRON_I2C_BYTE12);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x13, CONFIG::NEUTRON_I2C_BYTE13);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x14, CONFIG::NEUTRON_I2C_BYTE14);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x15, CONFIG::NEUTRON_I2C_BYTE15);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x16, CONFIG::NEUTRON_I2C_BYTE16);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x17, CONFIG::NEUTRON_I2C_BYTE17);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x18, CONFIG::NEUTRON_I2C_BYTE18);
    I2C::write_byte_data(FPGA_I2C_ADDRESS, 0x19, CONFIG::NEUTRON_I2C_BYTE19);
